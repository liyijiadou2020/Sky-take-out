# Sky-take-out
本项目是使用 Spring Boot 框架开发的一个在线外卖订购系统。（已完结）
...
- 订单管理：维护用户在移动端下达的订单，包含查询、取消、派送、完成，以及订单报表下载等功能。
- 数据统计：完成餐厅营业额、用户数量、订单等数据统计
...
- 个人信息：在个人中心页面中展示当前用户的基本信息，用户可以管理收货地址，可以查询历史订单数据
